package com.assestaudioplayer.assest_audio_player_plugin.justaudio;
...
public class AudioPlayer implements MethodCallHandler, Player.Listener, MetadataOutput {
    ...
    private final com.assestaudioplayer.assest_audio_player_plugin.com.justaudio.BetterEventChannel eventChannel;
    private final com.assestaudioplayer.assest_audio_player_plugin.com.justaudio.BetterEventChannel dataEventChannel;
    ...
    public AudioPlayer(final Context applicationContext, final BinaryMessenger messenger, final String id, Map<?, ?> audioLoadConfiguration, List<Object> rawAudioEffects) {
        ...
        eventChannel = new com.assestaudioplayer.assest_audio_player_plugin.com.justaudio.BetterEventChannel(messenger, "com.ryanheise.just_audio.events." + id);
        dataEventChannel = new com.assestaudioplayer.assest_audio_player_plugin.com.justaudio.BetterEventChannel(messenger, "com.ryanheise.just_audio.data." + id);
