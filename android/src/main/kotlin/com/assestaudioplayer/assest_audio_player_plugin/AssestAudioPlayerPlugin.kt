...
import com.assestaudioplayer.assest_audio_player_plugin.notification.*
import com.assestaudioplayer.assest_audio_player_plugin.stopwhencall.AudioFocusStrategy
import com.assestaudioplayer.assest_audio_player_plugin.stopwhencall.HeadsetManager
import com.assestaudioplayer.assest_audio_player_plugin.stopwhencall.StopWhenCall
import com.assestaudioplayer.assest_audio_player_plugin.stopwhencall.StopWhenCallAudioFocus
...
/** AssestAudioPlayerPlugin */
class AssestAudioPlayerPlugin: FlutterPlugin, MethodCallHandler, PluginRegistry.NewIntentListener,ActivityAware {
  var myActivity: Activity? = null
  var notificationChannel: MethodChannel? = null

  companion object {
    var instance: AssestAudioPlayerPlugin? = null
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "assest_audio_player_plugin.github.in")
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    if (call.method == "getSomething") {
      result.success("Something works on andorid..")
